...
export default function SuccessTransactionClient() {
  ...
  if (loading) return <Loader2 className="h-6 w-6 animate-spin mt-10 mx-auto" />;
  if (!tx) return <p className="text-center mt-10 text-red-500">Transaksi tidak ditemukan.</p>;
