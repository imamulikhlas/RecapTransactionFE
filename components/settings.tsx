...
import { Loader2, Mail, Key, Save, Edit, CheckCircle, ExternalLink, Info } from "lucide-react"
  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <p className="text-slate-400 mt-1">Connect your Gmail account for automatic transaction monitoring</p>
      </div>
            ...
            <div className="grid gap-6">
              <div className="space-y-2">
                ...
                {isEditing && !validateGmailEmail(formData.email_user) && formData.email_user && (
                  <p className="text-sm text-red-400">Please enter a valid Gmail address</p>
                )}
              </div>
                ...
                <div className="grid gap-4 md:grid-cols-2">
                  <div className="space-y-2">
                    ...
                    <div className="p-3 rounded-lg bg-slate-700/30 border border-slate-600">
                      ...
                      <p className="text-xs text-slate-400">Auto-configured for Gmail</p>
                    </div>
                  </div>
                  <div className="space-y-2">
              ...
              {isEditing ? (
                <>
                  ...
                  <Button
                    onClick={handleSave}
                    disabled={
                      saving || !formData.email_user || !formData.email_pass || !validateGmailEmail(formData.email_user)
                    }
            ...
            {!isEditing && settings && (
              <div className="mt-6 p-4 rounded-lg bg-green-900/20 border border-green-800">
                ...
                <p className="text-sm text-green-300">
                  Your Gmail account is connected and configured for automatic transaction monitoring. The system will
                  securely access your emails using Gmail's IMAP server (imap.gmail.com:993) with SSL encryption.
                </p>
              </div>
            )}
          </CardContent>
